...
def test(dataloader, model, loss_fn, batch_size, epoch, lr, optimizer):
    ...
    plt.savefig('alex_cm_' + str(batch_size) + '_' + str(epoch) + '_' + str(lr) + '_' + str(optimizer) + '.png')
...
test(test_loader, alexnet, loss_fn, batch_size, str(epochs), str(learning_rate), 'adam')
print("Done!")
